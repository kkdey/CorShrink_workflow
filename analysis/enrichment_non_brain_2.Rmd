---
title: 'Non Brain Enrichment Analysis : Genewide Corshrink'
author: "Kushal K Dey"
date: "5/28/2017"
...
write.table(cbind.data.frame(low_non_brain_2_genes), quote = FALSE, file = "../utilities/non_brain_2/low_non_brain.txt", row.names = FALSE, col.names = FALSE)
```


```{r}
tab <- read.delim("../utilities/non_brain_2/pathway_high.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain_2/pathway_high.tab")
maxpath = 75
...
```{r}
tab <- read.delim("../utilities/non_brain_2/pathway_low.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain_2/pathway_low.tab")
maxpath = 75
pathway <- pathway2[1:min(maxpath, dim(pathway2)[1]), ]
ensembl_genes <- pathway$members_input_overlap
pathway_list_genes <- sapply(ensembl_genes, function(x) return(strsplit(as.character(x), "; ")))
...
write.table(cbind.data.frame(low_non_brain_2_genes), quote = FALSE, file = "../utilities/non_brain_2/low_non_brain_2.txt", row.names = FALSE, col.names = FALSE)
```

```{r}
tab <- read.delim("../utilities/non_brain_2/pathway2_high.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain_2/pathway2_high.tab")
maxpath = 75
pathway <- pathway2[1:min(maxpath, dim(pathway2)[1]), ]
ensembl_genes <- pathway$members_input_overlap
pathway_list_genes <- sapply(ensembl_genes, function(x) return(strsplit(as.character(x), "; ")))
...
```{r}
tab <- read.delim("../utilities/non_brain_2/pathway2_low.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain_2/pathway2_low.tab")
maxpath = 75
pathway <- pathway2[1:min(maxpath, dim(pathway2)[1]), ]
ensembl_genes <- pathway$members_input_overlap
pathway_list_genes <- sapply(ensembl_genes, function(x) return(strsplit(as.character(x), "; ")))
