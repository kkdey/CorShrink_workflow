---
title: "Non Brain Enrichment Analysis : Tissuewide CorShrink"
author: "Kushal K Dey"
date: "5/27/2017"
output: html_document
---

In this script, we check for the enrichment of genes for high/low correlation in the 
non-brain regions. 
...
write.table(cbind.data.frame(low_non_brain_genes), quote = FALSE, file = "../utilities/non_brain/low_non_brain.txt", row.names = FALSE, col.names = FALSE)
```


```{r}
tab <- read.delim("../utilities/non_brain/pathway_high.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain/pathway_high.tab")
maxpath = 75
...
```{r}
tab <- read.delim("../utilities/non_brain/GO_high.tab")
head(cbind.data.frame(tab$term_name, tab$q.value), 100)
```

```{r}
tab <- read.delim("../utilities/non_brain/pathway_low.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```
```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain/pathway_low.tab")
maxpath = 75
pathway <- pathway2[1:min(maxpath, dim(pathway2)[1]), ]
ensembl_genes <- pathway$members_input_overlap
pathway_list_genes <- sapply(ensembl_genes, function(x) return(strsplit(as.character(x), "; ")))
...
```{r}
tab <- read.delim("../utilities/non_brain/GO_low.tab")
head(cbind.data.frame(tab$term_name, tab$q.value), 100)
```
...
write.table(cbind.data.frame(high_non_brain_genes), quote = FALSE, file = "../utilities/non_brain/high_non_brain_2.txt", row.names = FALSE, col.names = FALSE)

write.table(cbind.data.frame(low_non_brain_genes), quote = FALSE, file = "../utilities/non_brain/low_non_brain_2.txt", row.names = FALSE, col.names = FALSE)
```

```{r}
tab <- read.delim("../utilities/non_brain/pathway2_high.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain/pathway2_high.tab")
maxpath = 75
pathway <- pathway2[1:min(maxpath, dim(pathway2)[1]), ]
ensembl_genes <- pathway$members_input_overlap
pathway_list_genes <- sapply(ensembl_genes, function(x) return(strsplit(as.character(x), "; ")))
...
```{r}
tab <- read.delim("../utilities/non_brain/GO2_high.tab")
head(cbind.data.frame(tab$term_name, tab$q.value), 100)
```

```{r}
tab <- read.delim("../utilities/non_brain/pathway2_low.tab")
head(cbind.data.frame(tab$pathway, tab$q.value), 100)
```

```{r fig.height = 10}
pathway2 <- read.delim("../utilities/non_brain/pathway2_low.tab")
maxpath = 75
pathway <- pathway2[1:min(maxpath, dim(pathway2)[1]), ]
ensembl_genes <- pathway$members_input_overlap
pathway_list_genes <- sapply(ensembl_genes, function(x) return(strsplit(as.character(x), "; ")))
...
```{r}
tab <- read.delim("../utilities/non_brain/GO2_low.tab")
head(cbind.data.frame(tab$term_name, tab$q.value), 100)
```
