...
index <- grep("Skin", U)
lfdr_thresh <- apply(lfdr_mat, 2, function(x) {
            if(min(x[index]) < 0.05 && min(x[-index]) >  0.80){
              y <- 1
            }else{ y <- 0}
            return(y)})
...
### ENSG00000004139 (Breast specific)

```{r}
indices <- match("ENSG00000004139", gene_names_1)
```
...
```
### ENSG00000004399 (Breast specific)

```{r}
indices <- match("ENSG00000004399", gene_names_1)
```
...
### ENSG00000148337 (Brain specific)

```{r}
indices <- match("ENSG00000148337", gene_names_1)
```
...
### ENSG00000143110 (Thyroid specific)

```{r}
indices <- match("ENSG00000143110", gene_names_1)
```
...
### ENSG00000169896 (Adipose specific)

```{r}
indices <- match("ENSG00000169896", gene_names_1)
```
