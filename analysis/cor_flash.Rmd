---
title: "FLASH - analysis - correlation matrix"
author: "Kushal K Dey"
date: "5/18/2017"
...
In this script, we check for the performance of FLASH on the sample correlation matrix. We look at the output generated from Greedy FLASH for $K=15$.
...
Why are the green chunks occurring? An intuitive feeling is probably this gene is giving
higher weights in opoosite direction to Factor 4. We check how each factor is loaded on each gene and is it sparse? 
